...
Description: Dungeons of Dagestan is a massive, walkabout, 2d adventure game where you complete quests and objectives
...
Dev Note to JAYDEN: when adding a structure at a random coordinate make sure that it's x and y are plugged through the player.relateX() and player.relateY() functions as follows:
...
(In simple english) if you have an x and y put them though the "relate" functions before drawing them.
